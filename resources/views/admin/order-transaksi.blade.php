...
<body id="page-top">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="mb-4">
            <a href="{!! asset('transaksiAdmin') !!}" class="d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-list-ol fa-sm text-white-50"></i> List Transaksi</a>
            <a href="{!! asset('order-transaksiAdmin') !!}" class="d-sm-inline-block btn btn-sm btn-primary shadow-sm active"><i class="fas fa-list-ul fa-sm text-white-50"></i> List Orderan</a>
          </div>

          <!-- Data Table Order -->
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">Data List Orderan</h6>
            </div>
            <div class="card-body">
                ...
                <table class="table table-borderless table-striped" id="dataTable" width="100%" cellspacing="0">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>Terbayar</td>
                      <td>Tidak make saos</td>
                      <td class="text-center">
                        <a class="btn btn-sm btn-dark m-1" data-toggle="modal" data-target="#editModal"><i class="fas fa-pencil-alt text-white"></i></a>
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel">Edit List Orderan Transaksi</h5>
  ...
  <div class="modal fade" id="deleteModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel">Delete List Order?</h5>
          <button class="close" type="button" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">×</span>
          </button>
        </div>
