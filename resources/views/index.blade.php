...
<head>
	...
	<title>The Flash | E-sport Team</title>
...
<body id="home" data-spy="scroll" data-target=".navbar" data-offset="50">
	...
	<section class="hero-area">
		<div class="block">
			...
			<a href="{{ url('/signin') }}" class="btn btn-transparent">Sign in</a>
		</div>
	</section>
	<!-- //Welcome -->
			...
			<div class="row portfolio-items-wrapper">
				...
				<div class="mix col-md-4 {{ $merch->kategori }}">
					<div class="portfolio-block">
						<img class="img-responsive" src="{{ asset('file/merch/'.$merch->foto) }}" alt="">
						<div class="caption">
				...
				{{-- <div class="mix col-md-4 hoodie">
					<div class="portfolio-block">
						<img class="img-responsive" src="img/merch/tshirt.png" alt="">
						<div class="caption">
							<a class="search-icon image-popup" data-effect="mfp-with-zoom"
								href="img/merch/tshirt.png" data-lightbox="image-1">
								<i class="tf-ion-search"></i>
							</a>
							<h4><a href="">Hoodie</a></h4>
							<p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Ullam, nemo!</p>
						</div>
					</div>
				</div>
				<div class="mix col-md-4 accessories">
					<div class="portfolio-block">
						<img class="img-responsive" src="img/merch/tshirt.png" alt="">
						<div class="caption">
							<a class="search-icon image-popup" data-effect="mfp-with-zoom"
			...
			<div class="row wow fadeInUp" data-wow-duration="500ms">
				<div class="col-lg-12">
					...
					<div class="copyright text-center">
						...
						<p>Design And Developed by <a href="http://www.theflash.com"> TeamTime.</a>
							<br>
							Copyright
							&copy; <script>
